...
def login_required(view):
    """Wrap all routes requiring a login to check for a logged in user. Return
    the view if a user session is active, else return wrapped view.
    """
...
def logout():
    ...
    """
    session.clear()
    flash('Thank you for using our site.')
    return redirect(url_for('.login'))
